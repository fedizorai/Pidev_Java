...
public class Evenement {
   private int id,categorie_id,max_places_event;
    ...
    private CategorieEvent cate;

    public CategorieEvent getCate() {
        return cate;
    }

    public void setCate(CategorieEvent cate) {
        this.cate = cate;
    }
    ...
    public Evenement(int max_places_event, String nom_event, String lieu_event, Date date_event) {
        this.max_places_event = max_places_event;
        this.nom_event = nom_event;
        this.lieu_event = lieu_event;
        this.date_event = date_event;
